...
{      
  ...
  var libroNuevo = new libro("Las 48 Leyes del poder", "Robert Greene", "Español", "Oceano");

  //Generar un Arrays que me contenga todos los objetos que yo quiera ingresa o eiminar
  var libros = [];
  libros.push(new libro("las 33 estrategias de la guera","Robert Greene","Español","Oceano"));
  libros.push(new libro("El arte de la seducion","Robert Greene","Español","Oceano"));
